...
/// <summary>
/// I honestly did not put in any effort to understand this shit.
/// I jsut took this shit from: https://www.youtube.com/watch?v=vmLIy62Gsnk
/// </summary>
...
public class FadeObjectBlockingObject : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        if(DebugRay)
            Debug.DrawLine(Camera.transform.position, Target.transform.position + TargetPositionOffset);
    }
